...
inline const std::vector<EffectDescriptor>& builtInEffects()
{
    ...
    static const std::vector<EffectDescriptor> effects {
        ...
        { .kind = EffectKind::ParametricEq, .id = "parametricEq", .name = "Parametric EQ", .group = "",
          .params = {
              { .id = "band1Type", .name = "Band 1", .control = ParamControl::Choice, .min = 0, .max = 6, .step = 1,
                .choices = { "Off", "Bell", "Low Shelf", "High Shelf", "Notch", "Low Cut", "High Cut" },
                .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band1Type> },
              { .id = "band1Hz", .name = "  Frequency", .min = 20, .max = 20000, .step = 1, .unit = " Hz",
                .skewMidpoint = 1000, .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band1Hz> },
              { .id = "band1Gain", .name = "  Gain", .min = -24, .max = 24, .step = 0.1, .unit = " dB",
                .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band1GainDb> },
              { .id = "band1Q", .name = "  Q", .min = 0.1, .max = 30, .step = 0.01,
                .skewMidpoint = 1.5, .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band1Q> },
              { .id = "band2Type", .name = "Band 2", .control = ParamControl::Choice, .min = 0, .max = 6, .step = 1,
                .choices = { "Off", "Bell", "Low Shelf", "High Shelf", "Notch", "Low Cut", "High Cut" },
                .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band2Type> },
              { .id = "band2Hz", .name = "  Frequency", .min = 20, .max = 20000, .step = 1, .unit = " Hz",
                .skewMidpoint = 1000, .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band2Hz> },
              { .id = "band2Gain", .name = "  Gain", .min = -24, .max = 24, .step = 0.1, .unit = " dB",
                .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band2GainDb> },
              { .id = "band2Q", .name = "  Q", .min = 0.1, .max = 30, .step = 0.01,
                .skewMidpoint = 1.5, .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band2Q> },
              { .id = "band3Type", .name = "Band 3", .control = ParamControl::Choice, .min = 0, .max = 6, .step = 1,
                .choices = { "Off", "Bell", "Low Shelf", "High Shelf", "Notch", "Low Cut", "High Cut" },
                .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band3Type> },
              { .id = "band3Hz", .name = "  Frequency", .min = 20, .max = 20000, .step = 1, .unit = " Hz",
                .skewMidpoint = 1000, .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band3Hz> },
              { .id = "band3Gain", .name = "  Gain", .min = -24, .max = 24, .step = 0.1, .unit = " dB",
                .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band3GainDb> },
              { .id = "band3Q", .name = "  Q", .min = 0.1, .max = 30, .step = 0.01,
                .skewMidpoint = 1.5, .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band3Q> },
              { .id = "band4Type", .name = "Band 4", .control = ParamControl::Choice, .min = 0, .max = 6, .step = 1,
                .choices = { "Off", "Bell", "Low Shelf", "High Shelf", "Notch", "Low Cut", "High Cut" },
                .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band4Type> },
              { .id = "band4Hz", .name = "  Frequency", .min = 20, .max = 20000, .step = 1, .unit = " Hz",
                .skewMidpoint = 1000, .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band4Hz> },
              { .id = "band4Gain", .name = "  Gain", .min = -24, .max = 24, .step = 0.1, .unit = " dB",
                .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band4GainDb> },
              { .id = "band4Q", .name = "  Q", .min = 0.1, .max = 30, .step = 0.01,
                .skewMidpoint = 1.5, .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band4Q> },
              { .id = "band5Type", .name = "Band 5", .control = ParamControl::Choice, .min = 0, .max = 6, .step = 1,
                .choices = { "Off", "Bell", "Low Shelf", "High Shelf", "Notch", "Low Cut", "High Cut" },
                .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band5Type> },
              { .id = "band5Hz", .name = "  Frequency", .min = 20, .max = 20000, .step = 1, .unit = " Hz",
                .skewMidpoint = 1000, .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band5Hz> },
              { .id = "band5Gain", .name = "  Gain", .min = -24, .max = 24, .step = 0.1, .unit = " dB",
                .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band5GainDb> },
              { .id = "band5Q", .name = "  Q", .min = 0.1, .max = 30, .step = 0.01,
                .skewMidpoint = 1.5, .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band5Q> },
              { .id = "band6Type", .name = "Band 6", .control = ParamControl::Choice, .min = 0, .max = 6, .step = 1,
                .choices = { "Off", "Bell", "Low Shelf", "High Shelf", "Notch", "Low Cut", "High Cut" },
                .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band6Type> },
              { .id = "band6Hz", .name = "  Frequency", .min = 20, .max = 20000, .step = 1, .unit = " Hz",
                .skewMidpoint = 1000, .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band6Hz> },
              { .id = "band6Gain", .name = "  Gain", .min = -24, .max = 24, .step = 0.1, .unit = " dB",
                .access = fieldAccess<&S::parametricEq, &ParametricEqSettings::band6GainDb> },
        ...
        { .kind = EffectKind::GraphicEq31, .id = "graphicEq31", .name = "Graphic EQ (31 bands)", .group = "",
          .params = {
              { .id = "band1", .name = "20 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band1> },
              { .id = "band2", .name = "25 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band2> },
              { .id = "band3", .name = "31.5 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band3> },
              { .id = "band4", .name = "40 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band4> },
              { .id = "band5", .name = "50 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band5> },
              { .id = "band6", .name = "63 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band6> },
              { .id = "band7", .name = "80 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band7> },
              { .id = "band8", .name = "100 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band8> },
              { .id = "band9", .name = "125 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band9> },
              { .id = "band10", .name = "160 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band10> },
              { .id = "band11", .name = "200 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band11> },
              { .id = "band12", .name = "250 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band12> },
              { .id = "band13", .name = "315 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band13> },
              { .id = "band14", .name = "400 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band14> },
              { .id = "band15", .name = "500 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band15> },
              { .id = "band16", .name = "630 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band16> },
              { .id = "band17", .name = "800 Hz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band17> },
              { .id = "band18", .name = "1 kHz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band18> },
              { .id = "band19", .name = "1.25 kHz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band19> },
              { .id = "band20", .name = "1.6 kHz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band20> },
              { .id = "band21", .name = "2 kHz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band21> },
              { .id = "band22", .name = "2.5 kHz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band22> },
              { .id = "band23", .name = "3.15 kHz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band23> },
              { .id = "band24", .name = "4 kHz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band24> },
              { .id = "band25", .name = "5 kHz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band25> },
              { .id = "band26", .name = "6.3 kHz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band26> },
              { .id = "band27", .name = "8 kHz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band27> },
              { .id = "band28", .name = "10 kHz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band28> },
              { .id = "band29", .name = "12.5 kHz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band29> },
              { .id = "band30", .name = "16 kHz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band30> },
              { .id = "band31", .name = "20 kHz", .min = -12, .max = 12, .step = 0.5, .unit = " dB",
                .access = fieldAccess<&S::graphicEq31, &GraphicEq31Settings::band31> } } },
