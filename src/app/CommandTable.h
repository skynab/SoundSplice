...
inline const std::vector<Definition>& all()
{
    static const std::vector<Definition> table {
        ...
        { measureLoudness,  "Measure Loudness",     "Edit", "Measure the loudness (EBU R128) and true peak of the audio editor's selection, or the whole clip, into the Analyser pane.", {} },
