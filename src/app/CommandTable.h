...
inline const std::vector<Definition>& all()
{
    static const std::vector<Definition> table {
        ...
        { detectPitch,      "Detect Pitch",         "Analyze", "The note the audio editor's selection (or the clip's start) is nearest, and how many cents off it is.", {} },
        { slidingStretch,   "Sliding Stretch...",   "Edit", "Change the whole clip's tempo and pitch gradually, from one amount at its start to another at its end.", {} },
        ...
        { crossfadeTracks,  "Crossfade Tracks...",  "Edit", "Hand one audio track over to another across the time selection: the upper fades out as the lower fades in.", {} },
